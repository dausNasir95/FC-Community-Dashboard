...
export default async function AdminCollectionsPage({ searchParams }: { searchParams: Promise<Record<string, string | undefined>> }) {
  ...
  return <ResourceManager resource="collections" title="Collections" rows={data.rows as Record<string, unknown>[]} columns={["title", "status", "is_published", "updated_at"]} searchParams={params} />;
}
